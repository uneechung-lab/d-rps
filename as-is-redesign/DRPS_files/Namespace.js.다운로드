...
if(nexacro.Version != 17) {
	var msg = '넥사크로플랫폼 17용 Eco-Library 입니다.\n넥사크로플랫폼 ' + nexacro.Version + '용 Eco-Library를 사용해야 합니다.';
	trace(msg);
	alert(msg);
}
...
{
	/**
	 * <font size="3" color="red"> <strong> nexacro platform 17</strong> </font> EcoLibrary.<br><br>
