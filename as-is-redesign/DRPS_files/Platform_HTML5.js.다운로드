		...
		nexacro._createSysEvent_ForwardFuncs = function (_cur_win) {
			...
			_cur_win._syshandler_ontouchstart_forward = function (evt) {
				...
				if (elem._is_accept_touch) {
					...
					if (elem.parent instanceof nexacro._ListViewCellControl && elem.parent._subComp && elem.parent._subComp._isEditableComponent && elem.parent._subComp._isEditableComponent() && elem.parent._subComp._input_element && elem.parent._subComp._input_element._is_accept_touch) {
